            ...
            <div class="top-bar-right">
                <div class="language-select">
                    ...
                    <ul class="topbar-sublist">
                        <li><img src="{{ asset('backend/images/icon/flag-germeny.svg')}}" alt="image"><span>Germeny</span></li>
                        <li><img src="{{ asset('backend/images/icon/flag-french.svg')}}" alt="image"><span>French</span></li>
                        <li><img src="{{ asset('backend/images/icon/flag-bangla.svg')}}" alt="image"><span>Bengali</span></li>
                    </ul>
                </div>
        ...
        <div class="menu-area">
            ...
            <div class="main-menu">
                ...
                <ul class="menu-list">
                    ...
                    <li class=""><a href="job-listing2.html">Find Jobs</a></li>
                        ...
                        <div class="btn-group dropdown">
                            ...
                            <div class="notifacion-card dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                ...
                                <ul>
                                    <li>
                                        <div class="icon">
                                            <img src="{{ asset('backend/images/bg/company-logo/notifacion-1.png')}}" alt="">
                                        </div>
                                        <div class="content">
                                            <h6><a href="#">Your application has accepted in 5 vacancies.</a></h6>
                                            <span><img src="{{ asset('backend/images/icon/clock-1.svg')}}" alt=""> 10 min ago</span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="icon">
                                            <img src="{{ asset('backend/images/bg/company-logo/notifacion-2.png')}}" alt="">
                                        </div>
                                        <div class="content">
                                            <h6><a href="#">Your application has accepted in 5 vacancies.</a></h6>
                                            <span><img src="{{ asset('backend/images/icon/clock-1.svg')}}" alt=""> 10 min ago</span>
                                    ...
                                    <li>
                                        <div class="icon">
                                            <img src="{{ asset('backend/images/bg/company-logo/notifacion-3.png')}}" alt="">
                                        </div>
                                        <div class="content">
                                            <h6><a href="#">Your application has accepted in 5 vacancies.</a></h6>
                                            <span><img src="{{ asset('backend/images/icon/clock-1.svg')}}" alt=""> 10 min ago</span>
        ...
        <div class="row mb-60">
            <div class="col-12 d-flex flex-wrap align-items-end justify-content-md-between justify-content-start gap-3">
                ...
                <div class="explore-btn">
                    <a href="category.html">Explore More <span><img src="{{ asset('backend/images/icon/explore-elliose.svg')}}"
                                                                    alt=""></span></a>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row mb-60">
            <div class="col-12 d-flex flex-wrap align-items-end justify-content-md-between justify-content-start gap-3">
                ...
                <div class="explore-btn">
                    <a href="job-listing2.html">Explore More <span><img src="{{ asset('backend/images/icon/explore-elliose.svg')}}"
                                                                        alt=""></span></a>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="feature-card">
                    <div class="company-area">
                        <div class="logo">
                            <img src="{{ asset('backend/images/bg/company-logo/company-01.png')}}" alt="">
                        </div>
                    ...
                    <div class="job-discription">
                        <ul>
                            <li>
                                ...
                                <p><span class="title">Salary:</span> $80-$110 / <span class="time">Per month</span></p>
                            </li>
                            <li>
                                <img src="{{ asset('backend/images/icon/arrow2.svg')}}" alt="">
                    ...
                    <div class="job-type-apply">
                        <div class="apply-btn">
                            <a href="job-details.html"><span><img src="{{ asset('backend/images/icon/apply-ellipse.svg')}}" alt=""></span>Apply
                                Now</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="feature-card">
                    ...
                    <div class="job-discription">
                        <ul>
                            <li>
                                <img src="{{ asset('backend/images/icon/arrow2.svg')}}" alt="">
                                <p><span class="title">Salary:</span> $60-$70 / <span class="time">Per month</span></p>
                            </li>
                            <li>
                                <img src="{{ asset('backend/images/icon/arrow2.svg')}}" alt="">
            ...
            <div class="swiper location-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="location-card">
                            <div class="location-img">
                                <img class="img-fluid" src="{{ asset('backend/images/bg/dhaka1.png')}}" alt="">
                            </div>
                            <div class="location-content text-center">
                                <h5><a href="job-listing2.html"><img src="{{ asset('backend/images/icon/location.svg')}}" alt="">Dhaka,
                                        Bangladesh</a></h5>
                    ...
                    <div class="swiper-slide">
                        <div class="location-card">
                            <div class="location-img">
                                <img class="img-fluid" src="{{ asset('backend/images/bg/newyork1.png')}}" alt="">
                            </div>
                            <div class="location-content text-center">
                                <h5><a href="job-listing2.html"><img src="{{ asset('backend/images/icon/location.svg')}}" alt="">NewYork,
                                        USA</a>
                                </h5>
                    ...
                    <div class="swiper-slide">
                        <div class="location-card">
                            <div class="location-img">
                                <img class="img-fluid" src="{{ asset('backend/images/bg/chicago.png')}}" alt="">
                            </div>
                            <div class="location-content text-center">
                                <h5><a href="job-listing2.html"><img src="{{ asset('backend/images/icon/location.svg')}}" alt="">Chicago,
                                        Australia</a></h5>
                    ...
                    <div class="swiper-slide">
                        <div class="location-card">
                            <div class="location-img">
                                <img class="img-fluid" src="{{ asset('backend/images/bg/sylhet.png')}}" alt="">
                            </div>
                            <div class="location-content text-center">
                                <h5><a href="job-listing2.html"><img src="{{ asset('backend/images/icon/location.svg')}}" alt="">Sylhet,
                                        Bangladesh</a></h5>
            ...
            <div class="swiper testimonial-slider1">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="testimonial-card">
                            <div class="author-img">
                                <img src="{{ asset('backend/images/bg/testimonial-author1.png')}}" alt="">
                                <div class="quat-icon">
                            ...
                            <div class="testimonial-content">
                                ...
                                <p>On the other hand, we denounce with to the righteous indignation and dislike the men
                                    who are so
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-card">
                            <div class="author-img">
                                <img src="{{ asset('backend/images/bg/testimonial-author2.png')}}" alt="">
                                <div class="quat-icon">
                                    <img src="{{ asset('backend/images/icon/quat-icon.svg')}}" alt="">
                                </div>
                            </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('backend/images/bg/company-logo/trusted-company-01.png')}}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('backend/images/bg/company-logo/trusted-company-02.png')}}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('backend/images/bg/company-logo/trusted-company-03.png')}}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('backend/images/bg/company-logo/trusted-company-04.png')}}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('backend/images/bg/company-logo/trusted-company-05.png')}}" alt="">
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="company-logo">
                                <img src="{{ asset('backend/images/bg/company-logo/trusted-company-06.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="slick1">
                        ...
                        <div class="recruters-card">
                            <div class="company-area">
                                ...
                                <div class="name-location">
                                    ...
                                    <p><img src="{{ asset('backend/images/icon/location.svg')}}" alt=""> New-York, USA</p>
                                    <p><img src="{{ asset('backend/images/icon/person-2.svg')}}" alt=""> 45 People</p>
                                </div>
                            </div>
                    ...
                    <div class="slide-item">
                        <div class="recruters-card">
                            <div class="company-area">
                                <div class="logo">
                                    <img src="{{ asset('backend/images/bg/company-logo/company-07.png')}}" alt="">
                                </div>
                                <div class="name-location">
                                    <h5><a href="company-listing2.html">Germaine Company</a></h5>
                                    <p><img src="{{ asset('backend/images/icon/location.svg')}}" alt=""> Chicago, Australia</p>
                                    <p><img src="{{ asset('backend/images/icon/person-2.svg')}}" alt=""> 32 People</p>
                                </div>
                            </div>
                            <div class="job-details-vacancies">
                                <div class="apply-btn">
                    ...
                    <div class="slide-item">
                        <div class="recruters-card">
                            <div class="company-area">
                                <div class="logo">
                                    <img src="{{ asset('backend/images/bg/company-logo/company-08.png')}}" alt="">
                                </div>
                                <div class="name-location">
                                    <h5><a href="company-listing2.html">Techman Digita</a></h5>
                                    <p><img src="{{ asset('backend/images/icon/location.svg')}}" alt=""> Dhaka, Bangladesh</p>
                                    <p><img src="{{ asset('backend/images/icon/person-2.svg')}}" alt=""> 35 People</p>
                                </div>
                            </div>
                            <div class="job-details-vacancies">
                                <div class="apply-btn">
                    ...
                    <div class="slide-item">
                        <div class="recruters-card">
                            <div class="company-area">
                                <div class="logo">
                                    <img src="{{ asset('backend/images/bg/company-logo/company-09.png')}}" alt="">
                                </div>
                                <div class="name-location">
                                    <h5><a href="company-listing2.html">Tario.Co Ltd</a></h5>
                                    <p><img src="{{ asset('backend/images/icon/location.svg')}}" alt=""> Sylhet, Bangladesh</p>
                                    <p><img src="{{ asset('backend/images/icon/person-2.svg')}}" alt=""> 55 People</p>
                                </div>
                            </div>
                            <div class="job-details-vacancies">
                                <div class="apply-btn">
                ...
                <div class="footer-widget">
                    ...
                    <div class="menu-container">
                        <ul>
                            ...
                            <li><a href="job-listing2.html">Browse Jobs <i class='bx bx-up-arrow-alt'></i></a></li>
                ...
                <div class="footer-widget">
                    ...
                    <div class="menu-container">
                        <ul>
                            ...
                            <li><a href="job-listing2.html">Jobs Featured <i class='bx bx-up-arrow-alt'></i></a></li>
            ...
            <div class="row border-top align-items-center">
                <div class="col-lg-6 d-flex  justify-content-lg-start justify-content-center">
                    <div class="copyright-area">
                        <p>©Copyright 2023 <a href="#">JOBES</a> | Design By <a href="https://www.egenslab.com/">Egenslab</a>
                        </p>
                    </div>
                </div>
                <div class="col-lg-6 d-flex justify-content-lg-end justify-content-center">
