                        ...
                        <ul class="recent-activitys">
                            <li>
                                <div class="company-img">
                                    <img src="{{ asset('backend/images/bg/company-logo/recent-activity-01.png')}}" alt="">
                                </div>
                                <div class="content">
                                    <h6><a href="blog-details.html">Your application has accepted in 2 vacancies.</a></h6>
                                    <span><img src="{{ asset('backend/images/icon/clock-1.svg')}}" alt=""> 7 hour ago</span>
                                </div>
                            </li>
                            <li>
                                <div class="company-img">
                                    <img src="{{ asset('backend/images/bg/company-logo/recent-activity-02.png')}}" alt="">
                                </div>
                                <div class="content">
                                    <h6><a href="blog-details.html">1 Day Left For Your Premium Package To Expire.</a></h6>
                                    <span><img src="{{ asset('backend/images/icon/clock-1.svg')}}" alt=""> 5 hour ago</span>
                                </div>
                            </li>
                            <li>
                                <div class="company-img">
                                    <img src="{{ asset('backend/images/bg/company-logo/recent-activity-03.png')}}" alt="">
                                </div>
                                <div class="content">
                                    <h6><a href="blog-details.html">Your Job Posted Published On Position WordPress.</a></h6>
                                    <span><img src="{{ asset('backend/images/icon/clock-1.svg')}}" alt=""> 1 hour ago</span>
                                </div>
                            </li>
                            <li>
                                <div class="company-img">
                                    <img src="{{ asset('backend/images/bg/company-logo/recent-activity-04.png')}}" alt="">
                                </div>
                                <div class="content">
                ...
                <div class="footer-widget four">
                    ...
                    <div class="app-list">
                        <ul>
                            ...
                            <li>
                                <a href="#"><img src="{{ asset('backend/images/icon/google-play.svg')}}" alt=""></a>
                            </li>
                        </ul>
                    </div>
                </div>
