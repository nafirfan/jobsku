                    ...
                    <div class="table-wrapper2">
                        <div class="title-and-btn">
                            ...
                            <div class="job-post-btn">
                                <a class="primry-btn-2" href="{{ route('job.create') }}">Create Job Post</a>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        <td data-label="Job Title">
                                            <div class="job-content">
                                                <h5><a href="{{ route('job.show', $item->name) }}">{{ $item->name }}</a>
                                                </h5>
                                                <p><img src="{{ asset('backend/images/icon/calender2.svg') }}"
                                                        alt=""><span>Deadline:</span>
                                                    {{ date('d M, Y', strtotime($item->expiration_pub)) }}</p>
                                            </div>
                                        </td>
                                        ...
                                        <td data-label="Action">
                                            <ul class="action-btn-group2">
                                                <li><a href="{{ route('job.show', $item->name) }}"
                                                ...
                                                <li><a href="{{ route('job.edit', $item->name) }}"
