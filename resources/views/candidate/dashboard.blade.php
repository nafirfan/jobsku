                                ...
                                <td data-label="Job Title">
                                    <div class="company-info">
                                        ...
                                        <div class="company-details">
                                            ...
                                            <ul>
                                                <li><img src="{{ asset('backend/images/icon/location.svg') }}"
                                                        alt="">New-York, USA</li>
                                                <li>
                                                    <img src="{{ asset('backend/images/icon/arrow2.svg') }}"
                                                        alt="">
                                ...
                                <td data-label="Job Title">
                                    <div class="company-info">
                                        ...
                                        <div class="company-details">
                                            ...
                                            <ul>
                                                <li><img src="{{ asset('backend/images/icon/location.svg') }}"
                                                        alt="">West London, UK</li>
                                                <li>
                                                    <img src="{{ asset('backend/images/icon/arrow2.svg') }}"
                                                        alt="">
                                                    <p><span class="title">Salary:</span> $30K-$40K /
                                        ...
                                        <div class="company-details">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    <img src="{{ asset('backend/images/icon/arrow2.svg') }}"
                                                        alt="">
                                                    <p><span class="title">Salary:</span> $40K-$60K /
