                ...
                <table class="eg-table table category-table mb-30">
                    ...
                    <tbody>
                        <tr>
                            <td data-label="Job Title">
                                <div class="company-info">
                                    ...
                                    <div class="company-details">
                                        <div class="top">
                                            <h6><a href="{{ route('home.jobDetails') }}">Senior UI/UX Designer</a></h6>
                            ...
                            <td data-label="Company"><a class="view-btn" href="{{ route('home.companyDetails') }}">Tech.Bath
                                    Com... </a>
                            </td>
                        ...
                        <tr>
                            <td data-label="Job Title">
                                <div class="company-info">
                                    ...
                                    <div class="company-details">
                                        <div class="top">
                                            <h6><a href="{{ route('home.jobDetails') }}">React JS Developer</a></h6>
                                            <span><img src="../assets/images/icon/calender2.svg" alt=""> 1 days
                                                ago</span>
                                        </div>
                                        <ul>
                            ...
                            <td data-label="Company"><a class="view-btn" href="{{ route('home.companyDetails') }}">Gangster
                                    Group</a></td>
                        ...
                        <tr>
                            <td data-label="Job Title">
                                <div class="company-info">
                                    ...
                                    <div class="company-details">
                                        <div class="top">
                                            <h6><a href="{{ route('home.jobDetails') }}">WordPress Developer</a></h6>
                            ...
                            <td data-label="Company"><a class="view-btn" href="{{ route('home.companyDetails') }}">Zoomly.Co
                                    Ltd</a></td>
                        ...
                        <tr>
                            <td data-label="Job Title">
                                <div class="company-info">
                                    ...
                                    <div class="company-details">
                                        <div class="top">
                                            <h6><a href="{{ route('home.jobDetails') }}">Mern-Stack Developer</a></h6>
                            ...
                            <td data-label="Company"><a class="view-btn"
                                    href="{{ route('home.companyDetails') }}">Marko-land Ltd</a></td>
                            <td data-label="Status"><button class="eg-btn purple-btn">Viewed</button></td>
                        </tr>
                        <tr>
                            <td data-label="Job Title">
