        ...
        <div class="form-wrapper">
            <form class="profile-form">
                <div class="section-title2">
                    <h5 class="d-flex align-items-baseline gap-1"><img src="../assets/images/icon/profile-settings.svg"
                            alt=""> Profile
                        Settings </h5>
                </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-permission mb-3">
                                <div class="title">
                                    ...
                                    <p>If you log in again you will able to see all the match jobs and get
                                        all information.</p>
                                </div>
                                <div class="form-check form-switch">
